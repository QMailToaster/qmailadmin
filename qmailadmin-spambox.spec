...
./configure \
      --prefix=%{_prefix} \
      --datadir=%{_datadir}/qmailadmin \
      --enable-autoresponder-path=%{_bindir} \
      --enable-cgibindir=%{_datadir}/qmailadmin \
      --enable-cgipath=/qmailadmin/index.cgi \
      --enable-domain-autofill=n \
      --enable-ezmlm-mysql=n \
      --enable-ezmlmdir=%{_bindir} \
      --enable-help=y \
      --enable-htmllibdir=%{_datadir}/qmailadmin \
      --enable-htmldir=%{_datadir}/qmailadmin \
      --enable-imagedir=%{_datadir}/qmailadmin/images \
...
pushd %{buildroot}%{_datadir}/qmailadmin
...
# Dirs
#------------------------------------------------------------------------------
%attr(0755,root,root) %dir %{_datadir}/qmailadmin
%attr(0755,root,root) %dir %{_datadir}/qmailadmin/html
%attr(0755,root,root) %dir %{_datadir}/qmailadmin/lang
%attr(0755,%{apacheuser},%{apachegroup}) %dir %{_datadir}/qmailadmin/images

# Files
#------------------------------------------------------------------------------
%attr(0644,root,root) %{_datadir}/qmailadmin/html/*
%attr(0644,root,root) %{_datadir}/qmailadmin/lang/*
%attr(-,%{apacheuser},%{apachegroup}) %{_datadir}/qmailadmin/images/*
%attr(0644,root,root) %{basedir}/include/qmailadmin.module
%attr(6755,vpopmail,vchkpw) %{_datadir}/qmailadmin/index.cgi
%attr(6755,vpopmail,vchkpw) %{_datadir}/qmailadmin/qmailadmin
